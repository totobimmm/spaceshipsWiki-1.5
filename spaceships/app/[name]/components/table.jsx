...
const Table = () => {
  ...
  return (
    <div className=" text-center flex flex-col gap-4 max-sm:gap-2 ">
      ...
      <p className=" md:text-2xl max-sm:text-xl ">model: {spaceship.name}</p>
      ...
      <p className=" md:text-2xl max-sm:text-xl ">Status: {spaceship.status}</p>
      <p className=" md:text-2xl max-sm:text-xl ">
        Primary Use: {spaceship.primaryUse}
      </p>
      <p className=" md:text-2xl max-sm:text-xl ">Length: {spaceship.length}</p>
      <p className=" md:text-2xl max-sm:text-xl ">Width: {spaceship.width}</p>
      <p className=" md:text-2xl max-sm:text-xl ">Height: {spaceship.height}</p>
      <p className=" md:text-2xl max-sm:text-xl ">
